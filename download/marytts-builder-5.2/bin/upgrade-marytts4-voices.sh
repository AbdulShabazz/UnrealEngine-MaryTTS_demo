...
java -showversion -Xmx1024m -Dmary.base="$MARY_BASE" -cp "$MARY_BASE/lib/marytts-builder-5.2-jar-with-dependencies.jar" marytts.tools.upgrade.Mary4To5VoiceConverter $*
